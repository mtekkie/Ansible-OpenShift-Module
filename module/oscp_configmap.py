...
DOCUMENTATION = '''
---
module: oscp_configmap
short_description: Open Shift Config Map
description:
    - Handles Config Maps in Open Shift Enterprise.
...
def main():
    ...
    SERVICE  = API_BASE+"/namespaces/"+module.params.get("project")+"/configmaps/"
